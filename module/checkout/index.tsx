...
export default function Checkout() {
    ...
    async (payload:any) => await order(payload), {
      onSettled: async (data: any) => {
        ...
        setTimeout(()=> {
          ...
          message.error("Có lỗi xảy ra, vui lòng thử lại sau!", 3)
          setTimeout(()=> {
              router.push("/cart")
          }, 3)
        }
  ...
  return (
    <>
        ...
        <PageTitle name="Đặt hàng" />
        <div className={cx("checkout")}>
                <div className={cx("checkout-title")}>Thông tin đơn hàng</div>
                <Row className={cx("checkout-form")} justify='space-between' gutter={80}>
                  <Col span={8} className={`gutter-row ${cx("cart-total")}`} >
                    ...
                    <div className={cx("total-item")}>
                            <div className={cx("total-title")}>Tổng tiền:</div>
                    ...
                    <div className={cx("total-item")}>
                            <div className={cx("total-title")}>Phí vận chuyển:	</div>
                            <div className={cx("total-infor")}>	
                                <div >
                                    Flat rate: { " "}
                                    <DollarOutlined style={{fontSize: "15px", color: "#9c9c9c", marginRight: "4px"}} />
                    ...
                    <div className={cx("total-item")}>
                            <div className={cx("total-title")}>Tổng thanh toán:</div>
                            <div className={cx("total-infor")}>
                                <DollarOutlined style={{fontSize: "15px", color: "#9c9c9c", marginRight: "4px"}} />
                  ...
                  <Col span={10} className='gutter-row'>
                    ...
                    >
                        ...
                        <Form.Item wrapperCol={{ span: 24 }}>
                            <Button className={cx('btn')} htmlType='submit'>Đặt hàng</Button>
                        </Form.Item>
                    </Form>
                  </Col>
