...
import { getAllProduct, getProductByKeyword, getProductByImage, getProductList, IProductItem } from '../../api/ApiProduct'
...
export default function ListProduct() {
  ...
  const fetchData = async () => {
    if (path.includes('list-product')) {
      ...
      if(image !== ''){
        return getProductByImage(currentPage, image);
      } else {
  ...
  return (
    <>
        ...
        <PageTitle name= {path.includes('list-product') ? 'Sản phẩm' : `Tìm kiếm: ${keyword ? keyword : ''}`} />
